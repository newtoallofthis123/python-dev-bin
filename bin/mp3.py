...
def main():
    gui = Tk()
    gui.title("Player")
    gui.iconbitmap("I:/python-dev-bin/NoobScience/Assets/Gallery/icon.ico")
    ...
    back_img = PhotoImage(file='I:/python-dev-bin/NoobScience/Assets/prev.png')
    forward_img = PhotoImage(file='I:/python-dev-bin/NoobScience/Assets/next.png')
    play_img = PhotoImage(file='I:/python-dev-bin/NoobScience/Assets/play.png')
    pause_img = PhotoImage(file='I:/python-dev-bin/NoobScience/Assets/pause.png')
    stop_img = PhotoImage(file='I:/python-dev-bin/NoobScience/Assets/stop.png')
    exit_img = PhotoImage(file='I:/python-dev-bin/NoobScience/Assets/exit.png')
