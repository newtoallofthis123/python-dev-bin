...
intro = Tk()
width = str(intro.winfo_screenwidth())
height = str(intro.winfo_screenheight())
geo = width + "x" + height
intro.geometry(geo)
intro.overrideredirect(True)

img = PhotoImage(file="I:/python-dev-bin/NoobScience/Assets/noobscience.png")
label = Label(intro, image=img)
label.pack()

title = Label(intro, text="NoobScience", font=("Cascadia", 48), fg="white")
title.pack()

intro.after(5000, main)
