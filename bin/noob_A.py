try:
    ...
    print("                    -Noob-              ")
    wait = "Thanks for waking me up. I will be at your service. Wait, I am freshning up, don't input anything in the keyboard"
    notifier.show_toast("Noob", wait)
    ...
    def cal():
        try:
            ...
            print("Sorry, something went wrong. To trobuleshoot, read the following doc")
            print("This needs no external modules installed. Check if python is installed properly and check the python script for any errors or report the issue at https://github.com/newtoallofthis123/Noob/Issues")
    ...
    def calendar():
        try:
            ...
            notify_time = "The current time is: " + current_time_in_format
            notifier.show_toast("Noob Calendar", notify_time)
            ...
            print("Something went wrong. To trobuleshoot, read the doc below")
            print("Modules Used: \n1. calendar \n2. Time \n3. DateTime")
            print("Also Check if python is installed properly and check the python script for any errors or report the issue at https://github.com/newtoallofthis123/Noob/Issues")
            notifier.show_toast("Error, closing Noob, try again")
            exit()
    ...
    def alaram():
        try:
                    ...
                    if alarm_hour == current_hour:
                        if alarm_min == current_min:
                            if alarm_sec == current_sec:
                                print("Alarm Done")
                                notifier.show_toast("Noob Alarm", "Alarm is done, playing the alarm")
            ...
            print("Something went wrong. To trobuleshoot, read the doc below")
            print("Modules Used: \n1. playsound \n2. Time \n3. DateTime")
            print("Check if python is installed properly and check the python script for any errors or report the issue at https://github.com/newtoallofthis123/Noob/Issues")
            notifier.show_toast("Error, closing Noob, try again")
            exit()
        ...
        try:
            ...
            while True:
                try:
                    ...
                    notifier.show_toast("Noob Stopwatch", "Timer Stopped")
                    break
        except:
            print("Something went wrong. To trobuleshoot, read the doc below")
            print("Modules Used: \n1. Time")
    ...
    def timer():
        try:
            ...
            print("                                   Timer Gui. Check all the tabs open                         ")
            ...
            def timer():
               ...
               while times > -1:
                  ...
                  if(times == 0):
                     ...
                     notifier.show_toast("Noob Timer", "Timer is done. Playing the Alarm for the Timer")
                     playsound("alaram_sound.mp3")
                  times -= 1
            ...
            print("Something went wrong. To trobuleshoot, read the doc below")
            print("Modules Used: \n1. Tkinter \n2. Time \n3. Playsound")
            print("3rd party module used playsound: pip install playsound")
            print("Check if python is installed properly and check the python script for any errors or report the issue at https://github.com/newtoallofthis123/Noob/Issues")
            notifier.show_toast("Error, closing Noob, try again")
            exit()
    ...
    def wikicli():
        try:
            ...
            try:
                ...
                notify_search = "You have search for the term " + search + " in Wiki-Cli using Noob. Check your terminal for the results or use Wiki gui"
                notifier.show_toast("Noob Wiki-Cli", notify_search)
                if keyword == "a":
            ...
            print("Something went wrong. To trobuleshoot, read the doc below")
            print("Modules Used: \n1. wikipedia")
            print("3rd party modules used: wikipedia : pip install wikipedia")
            print("Check if python is installed properly and check the python script for any errors or report the issue at https://github.com/newtoallofthis123/Noob/Issues")
            notifier.show_toast("Error, closing Noob, try again")
            exit()
    ...
    def wiki():
        try:
            ...
            print("                          Wiki Gui should be running. Check all the tabs open                              ")
    ...
    def speed():
        try:
            ...
            print("Something went wrong. To trobuleshoot, read the doc below")
            print("Modules Used: \n1. speedtest-cli")
            print("3rd party modules used: speedtest-cli : pip install speedtest-cli")
            print("Check if python is installed properly and check the python script for any errors or report the issue at https://github.com/newtoallofthis123/Noob/Issues")
            notifier.show_toast("Error, closing Noob, try again")
            exit()
    ...
    def joke():
        try:
            ...
            print("Something went wrong. To trobuleshoot, read the doc below")
            print("Modules Used: \n1. pyjoke")
            print("3rd party Modules used: pyjoke : pip install pyjoke")
            print("Check if python is installed properly and check the python script for any errors or report the issue at https://github.com/newtoallofthis123/Noob/Issues")
            notifier.show_toast("Error, closing Noob, try again")
            exit()
    ...
    def qr():
        try:
            ...
            print("Something went wrong. To trobuleshoot, read the doc below")
            print("Modules Used: \n1. pyqrcode")
            print("3rd party Modules used: pyjoke : pip install pyqrcode")
            print("Check if python is installed properly and check the python script for any errors or report the issue at https://github.com/newtoallofthis123/Noob/Issues")
            notifier.show_toast("Error, closing Noob, try again")
            exit()
    ...
    def url():
        try:
            ...
            def processor():
                ...
                shortening = shorten.tinyurl.short(url.get())
            ...
            if __name__=="__main__":
                ...
                print("                        Url Shorterner gui using Tinyurl                             ")
                ...
                label = tk.Label(
                    gui,
                    text = "Shorten URL using tinyurl.com",
                    font=("Arial", 36),
                    bg="black",
                    fg="red",
                    ).pack(fill=tk.X, pady=2)
    ...
    def song():
        try:
            ...
            print("Something went wrong. To trobuleshoot, read the doc below")
            print("Modules Used: \n1. pygame")
            print("3rd party Modules used: pygame : pip install pygame")
            print("Check if python is installed properly and check the python script for any errors or report the issue at https://github.com/newtoallofthis123/Noob/Issues")
            notifier.show_toast("Error, closing Noob, try again")
            exit()
    ...
    def google():
        try:
            ...
            print("Something went wrong. To trobuleshoot, read the doc below")
            print("Modules Used: \n1. googlesearch")
            print("3rd party Modules used: google : pip install google")
            print("Check if python is installed properly and check the python script for any errors or report the issue at https://github.com/newtoallofthis123/Noob/Issues")
            notifier.show_toast("Error, closing Noob, try again")
            exit()
    ...
    choice = str.lower(input("How was the experince, do you want to quit or trobuleshoot any problems you had?(y/n)"))
    if choice == 'n':
        exit()
    elif choice == 'y':
        print("Something went wrong. To trobuleshoot, read the doc below")
        print("To use Noob without gTTS and internet, please comment out the following lines given below line26 to line 75")
        print("If noob is used without line26 and lin75, it will run faster and you will have a faster and smoother experince")
        print("But to do so, you must either run noob with gTTS once and comment it out later or run the audio.py with a internet connection")
        print("3rd party Modules Used: pyperclip3 PyQRCode wikipedia google ddgr youtube_dl pygame PyJoke beautifulsoup4 playsound gTTS speedtest-cli win10toast")
        print("To install: pip install pyperclip3 PyQRCode wikipedia google ddgr youtube_dl pygame PyJoke beautifulsoup4 playsound gTTS speedtest-cli win10toast")
        print("Necessary Modules: \n1.win10toast \n2.playsound \n3.gTTS \n4.BeautifulSoup ")
        print("Check if python is installed properly and check the python script for any errors or report the issue at https://github.com/newtoallofthis123/Noob/Issues")
        notifier.show_toast("Error, closing Noob, try again")
        exit()
