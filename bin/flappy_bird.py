...
# Forked from https://github.com/carterjean/Flappy-Bird-in-Pygame
...
img = pygame.image.load('Assets/Gallery/Flappy_Bird/birdup.png')
bg = pygame.image.load('Assets/Gallery/Flappy_Bird/birdupbg.png')
pipe = pygame.image.load('Assets/Gallery/Flappy_Bird/birduppipe.png')
ground = pygame.image.load('Assets/Gallery/Flappy_Bird/birdupground.png')
